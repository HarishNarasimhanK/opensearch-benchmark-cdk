...
# --- Step 7: CodeGuru Profiler agent ---
...
printf '\n-javaagent:/home/ec2-user/codeguru/codeguru-profiler-java-agent-standalone.jar="profilingGroupName:opensearch-{{SAFE_BRANCH}}-profiling,region:{{REGION}},heapSummaryEnabled:true"\n' >> /home/ec2-user/opensearch/config/jvm.options
